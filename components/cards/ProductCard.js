        ...
        <>
          ...
          >
            <div className="product-img-action-wrap relative @container">
              ...
              <div
                className={`product-img overflow-hidden @[200px]:h-[300px] @[250px]:h-[400px]`}
              >
                <Link href="/products/[slug]" as={`/products/${slug}`}>
                  <Image
                    className="default-img h-full w-full hover:scale-125 transition-all duration-300 ease-in-out rounded-t"
                    src={image || noImage}
                    alt={product_name}
                    width={226}
                    height={400}
