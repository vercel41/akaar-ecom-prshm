...
const DrawerRight = ({ title, children, show, setShow }) => {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div
        className={`fixed top-0 right-0 z-50 w-[100vw] lg:w-[31rem] h-[100dvh] overflow-y-auto transition-transform ease-in-out duration-300 transform ${
      ...
      >
        <div className="relative h-full">
          ...
          <div className="flex items-center justify-between px-5 py-2 text-slate-900 border-b-[1px] border-slate-300">
            <h3 className="text-2xl font-noto_serif font-semibold">
              {title ? title : null}
            </h3>
            <button
