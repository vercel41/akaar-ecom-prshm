        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="form-control border border-gray-100 rounded p-2">
            ...
            {!editMode ? (
              ...
              <>
                <select
                  className="select w-full h-12 text-base font-noto_serif font-normal px-2 border border-gray-300 focus:outline-none focus:border-primary"
            ...
            {!editMode ? (
              ...
              <>
                <div className="flex items-center group">
                  <div className="h-12 py-2.5 min-w-fit text-base font-noto_serif font-normal px-2 border bg-slate-100 border-gray-300 group-focus-within:border-primary group-focus-within:border-r-gray-300">
