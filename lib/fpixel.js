...
/**
 * The function `getInitiateCheckoutPixelData` generates pixel data for purchase items including item
 ...
 * @returns The function `getInitiateCheckoutPixelData` returns an object with the following properties:
